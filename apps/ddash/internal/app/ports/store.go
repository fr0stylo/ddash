...
type GitHubInstallationStore interface {
	UpsertGitHubInstallationMapping(ctx context.Context, mapping GitHubInstallationMapping) error
	ListGitHubInstallationMappings(ctx context.Context, organizationID int64) ([]GitHubInstallationMapping, error)
	DeleteGitHubInstallationMapping(ctx context.Context, installationID, organizationID int64) error
	GetOrganizationByGitHubInstallationID(ctx context.Context, installationID int64) (Organization, error)
	CreateGitHubSetupIntent(ctx context.Context, intent GitHubSetupIntent) error
	GetGitHubSetupIntentByState(ctx context.Context, state string) (GitHubSetupIntent, error)
